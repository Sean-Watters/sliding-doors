...
Different instantiations of fresh lists yield different free structures, whose universal properties we prove, again by free-forgetful adjunctions.
...
\begin{tabular}{  |c|m{11em}|m{15em}| }
  ...
  \hline
  Total order, $\leq$ & Sorted lists & Ordered Commutative Monoid \\
  Strict total order, $<$ & Sorted lists without duplicates & Ordered Idempotent Commutative Monoid \\
