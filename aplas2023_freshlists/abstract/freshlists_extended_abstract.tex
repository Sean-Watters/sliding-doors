...
We require the data provided by the ordering to perform sorting (and crucially, to implement $\mergesymb{}$).
...
With the categories in place, we can prove that the type of sorted lists is functorial, and left adjoint to the forgetful functor $\forgetoicm$.
